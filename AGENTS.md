...
- Zellij 0.45.x rejects Kitty Unicode placeholders (`U=1`). Use renderer-owned direct Kitty placements and modal masks inside Zellij; do not switch previews to `ImageProtocol::KittyPlaceholder` until Zellij ships placeholder support.
